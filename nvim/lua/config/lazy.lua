...
require("lazy").setup({
  ...
  -- Wyszukiwarka
  {
    ...
    config = function()
      ...
      map("n", "<leader>fd", ":Telescope diagnostics<CR>", { desc = "Diagnostyka" })
    end,
  },
  -- Drzewo plików
  {
  ...
  -- Lintery
  {
    ...
    config = function()
      ...
      -- Uruchamiaj linter automatycznie
  ...
  -- Podpowiedzi skrótów
  {
    ...
    config = function()
      ...
      wk.setup({ delay = 500 })
      wk.add({
        { "<leader>f", group = "Znajdź" },
        { "<leader>s", group = "Podziel okno" },
        { "<leader>g", group = "Git" },
        { "<leader>c", group = "Kod" },
